...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    {
      ...
      roles: ["Admin", "Manager"],
      subItems: [ 
        { name: "View Dashboard", path: "/", roles: ["Admin", "Manager"] },
      ],
    },
    // {
    ...
    //   roles: ["Admin"],
    //   subItems: [
    //     { name: "Form Elements", path: "/form-elements", pro: false, roles: ["Admin"] }
    //   ],
    // },
    // {
    //   name: "Tables",
    ...
    //   roles: ["Admin", "Student"],
    //   subItems: [
    //     { name: "Basic Tables", path: "/basic-tables", pro: false , roles: ["Admin", "Student"] },
    //   ],
    // },
    // {
    //   name: "Pages",
    ...
    //   roles: ["Admin", "Student"],
    //   subItems: [
    //     { name: "Blank Page", path: "/blank", pro: false, roles: ["Admin", "Student"] },
    //     { name: "404 Error", path: "/error-404", pro: false, roles: ["Admin", "Student"] },
    //   ],
    // },
    // {
    ...
    //   roles: ["Admin", "Student"],
    //   subItems: [
    //     { name: "All", path: "/all-withdrawals", pro: false },
    //     { name: "Pending", path: "/basic-tables", pro: false },
    //     { name: "Approved", path: "/form-elements", pro: false },
    //     { name: "Completed", path: "/calendar", pro: false },
    //   ],
    // },
    {
      name: "New Registration",
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M8.50391 4.25C8.50391 3.83579 8.83969 3.5 9.25391 3.5H15.2777C15.4766 3.5 15.6674 3.57902 15.8081 3.71967L18.2807 6.19234C18.4214 6.333 18.5004 6.52376 18.5004 6.72268V16.75C18.5004 17.1642 18.1646 17.5 17.7504 17.5H16.248V17.4993H14.748V17.5H9.25391C8.83969 17.5 8.50391 17.1642 8.50391 16.75V4.25ZM14.748 19H9.25391C8.01126 19 7.00391 17.9926 7.00391 16.75V6.49854H6.24805C5.83383 6.49854 5.49805 6.83432 5.49805 7.24854V19.75C5.49805 20.1642 5.83383 20.5 6.24805 20.5H13.998C14.4123 20.5 14.748 20.1642 14.748 19.75L14.748 19ZM7.00391 4.99854V4.25C7.00391 3.00736 8.01127 2 9.25391 2H15.2777C15.8745 2 16.4468 2.23705 16.8687 2.659L19.3414 5.13168C19.7634 5.55364 20.0004 6.12594 20.0004 6.72268V16.75C20.0004 17.9926 18.9931 19 17.7504 19H16.248L16.248 19.75C16.248 20.9926 15.2407 22 13.998 22H6.24805C5.00541 22 3.99805 20.9926 3.99805 19.75V7.24854C3.99805 6.00589 5.00541 4.99854 6.24805 4.99854H7.00391Z" fill="currentColor"></path></svg>`,
      roles: ["Admin", "Clerk", "Student", "Manager"],
      subItems: [
        { name: "Admin Registration", path: "/admin-registration", pro: false, roles: ["Admin", "Clerk", "Student", "Manager"] },
    ...
    },
    {
      ...
      subItems: [
        { name: "Registration Reports", path: "/registration-report", pro: false, roles: ["Admin", "Clerk", "Student", "Manager"] },
      ],
    },
    // {
    //   name: "Reports",
    //   icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.25 3.75C5.14543 3.75 4.25 4.64543 4.25 5.75V18.25C4.25 19.3546 5.14543 20.25 6.25 20.25H17.75C18.8546 20.25 19.75 19.3546 19.75 18.25V8.45711C19.75 7.92737 19.5393 7.41828 19.1642 7.0432L16.9568 4.83579C16.5817 4.46071 16.0726 4.25 15.5429 4.25H6.25ZM5.75 5.75C5.75 5.19772 6.19772 4.75 6.75 4.75H15.25V8C15.25 8.41421 15.5858 8.75 16 8.75H19.25V18.25C19.25 18.8023 18.8023 19.25 18.25 19.25H6.75C6.19772 19.25 5.75 18.8023 5.75 18.25V5.75Z" fill="currentColor"/><path d="M8.75 12.5C8.75 12.0858 9.08579 11.75 9.5 11.75H14.5C14.9142 11.75 15.25 12.0858 15.25 12.5C15.25 12.9142 14.9142 13.25 14.5 13.25H9.5C9.08579 13.25 8.75 12.9142 8.75 12.5Z" fill="currentColor"/><path d="M9.5 14.75C9.08579 14.75 8.75 15.0858 8.75 15.5C8.75 15.9142 9.08579 16.25 9.5 16.25H12.5C12.9142 16.25 13.25 15.9142 13.25 15.5C13.25 15.0858 12.9142 14.75 12.5 14.75H9.5Z" fill="currentColor"/></svg>`,
    //   roles: ["Admin"],
    //   subItems: [
    //     { name: "Analytics", path: "/reports", pro: false, roles: ["Admin"] },
    //   ],
    // },
    {
      name: "Branches",
      ...
      roles: ["Admin"],
      subItems: [
        { name: "Manage Branches", path: "/manage-branch", pro: false, roles: ["Admin"] },
    ...
    },
    {
      ...
      roles: ["Admin", "Manager"],
      subItems: [
        { name: "Manage Courses", path: "/manage-course", pro: false, roles: ["Admin", "Manager"] },
    ...
    },
    {
      ...
      roles: ["Admin"],
      subItems: [
        { name: "Manage Users", path: "/manage-user", pro: false, roles: ["Admin"] },
  ...
  get filteredNavItems() {
    // If user is a Student, only show "New Registration" menu item
    const isStudent = this.userDetails?.role?.includes('Student') && 
                      !this.userDetails?.role?.includes('Admin') && 
                      !this.userDetails?.role?.includes('Clerk') &&
                      !this.userDetails?.role?.includes('Manager');
    
    if (isStudent) {
      return this.navItems
        .filter(item => item.name === "New Registration")
        .map(item => ({
          ...item,
          subItems: item.subItems?.filter(
            sub => !sub.roles || sub.roles.some(role => this.userDetails?.role?.includes(role)) !== false
          ),
        }));
    }
    
    // For Admin and Clerk, show all items based on roles
    return this.navItems
      .filter(item =>
        !item.roles || item.roles.some(role => this.userDetails?.role?.includes(role)) !== false
      ) 
      .map(item => ({
        ...item,
        subItems: item.subItems?.filter(
