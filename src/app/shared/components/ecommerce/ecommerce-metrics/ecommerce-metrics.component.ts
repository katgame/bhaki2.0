...
export class EcommerceMetricsComponent implements OnInit {
  ...
  getAllRegistration() {
    ...
    endDate.setDate(endDate.getDate() - 10); // Last 30 days
    const endDateFormatted = endDate.toISOString().split('T')[0];

    this.bhakiService.getAllRegistrationsByRange(endDateFormatted, startDate).subscribe({
  ...
  getBranches() {
    ...
    this.bhakiService.getMontlyBranchesForDashBoard().subscribe({
      next: (res) => {
        this.Branch = res;
      },
      error: (err) => {
  ...
  public icons = {
    ...
    house: `<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16"><path stroke="currentColor" stroke-linejoin="round" stroke-width="2" d="M8 8v1h4V8m4 7H4a1 1 0 0 1-1-1V5h14v9a1 1 0 0 1-1 1ZM2 1h16a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1Z"/></svg>`
  }
}
